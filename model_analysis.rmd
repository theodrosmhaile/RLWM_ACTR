...
```{r model plots}
plt.sim.rl <- data.frame('accuracy'= c(RL.sim.dat[,1:12] %>% t() %>% c(),RL.sim.dat[,13:24] %>% t() %>% c()), 'index'=rep(1:12,50), 'condition'=c(rep('set3', 12*25), rep('set6',12*25)))
...
plt.sim.ltm <- data.frame('accuracy'= c(LTM.sim.dat[,1:12] %>% t() %>% c(),LTM.sim.dat[,13:24] %>% t() %>% c()), 'index'=rep(1:12,250), 'condition'=c(rep('set3', 12*125), rep('set6',12*125)))
...
plt.sim.rl_ltm <- data.frame('accuracy'= c(RL_LTM.sim.dat[,1:12] %>% t() %>% c(),RL_LTM.sim.dat[,13:24] %>% t() %>% c()), 'index'=rep(1:12,6250), 'condition'=c(rep('set3', 12*3125), rep('set6',12*3125)))
