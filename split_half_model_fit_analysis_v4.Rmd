...
=======
sdat.h2 = fread('./RLWM_data/Half2_all_subject_n83_learn_test_data.csv', header = T) 
...
<<<<<<< HEAD
                  ...
                  matrix(sdat.h2[ ,26],
                         nrow = numel(sdat.h2[ ,25]), ncol = 12) )
=======
                   matrix(sdat.h2[ ,25],nrow = numel(sdat.h2[ ,25]), ncol = 12),
                   sdat.h2[ ,13:24],
                  matrix(sdat.h2[ ,26],nrow = numel(sdat.h2[ ,25]), ncol = 12) )
>>>>>>> b398e802a2367b69cf29620a9678d34ace7d7332


RL.sim <- fromJSON('./simulated_data/RL_model/RL_sim_dat_032021.JSON')$data
...
sdat.list <- list('h1.n3' = sdat.repl.h1[,1:24], 
                  'h1.n6' = sdat.repl.h1[,25:24],
                  'h2.n3' = sdat.repl.h2[,1:24], 
                  'h2.n6' = sdat.repl.h2[,25:24]
                  
  
)
RL.sim.list <- list('n3' = RL.sim$set3_learn, 
                  'n6' = sdat.repl.h1[,25:24],
...
=======
  ...
  apply(sdat[, ns], 1,
        function(x, y)
          fit.subject(x, (cbind(
            bind_cols(eval(parse(text=paste0(model,'.sim$',x, 'learn')
                                 )
                           )
                      ) %>%
              t(),
            matrix(
              eval(parse(text=paste0(model,'.sim$',x, 'test'))),
              nrow = numel(eval(parse(text=paste0(model,'.sim$',x, 'test')))),
              ncol = 12
            )
          )))) %>%
>>>>>>> b398e802a2367b69cf29620a9678d34ace7d7332
...
=======
RL.BIC.half1.N3 <-  fit.models(model = 'RL',half = 1, setsize = 6, 2)
>>>>>>> b398e802a2367b69cf29620a9678d34ace7d7332
...
best.fits <- tibble('half1_N3' = half1.N3$model[half1.N3 %>% select(-contains('model')) %>% apply(., 2, which.min)],
                                    
                  'half1_N6' = half1.N6$model[half1.N6 %>% select(-contains('model')) %>% apply(., 2, which.min)],
                                
                  'half2_N3' = half2.N3$model[half2.N3 %>% select(-contains('model')) %>% apply(., 2, which.min)],
                                   
                  'half2_N6' = half2.N6$model[half2.N3 %>% select(-contains('model')) %>% apply(., 2, which.min)],
                                    
                  
                  )


best.fit.idx <- tibble('half1_N3' = half1.N3 %>% select(-contains('model')) %>% apply(., 2, which.min),
                     'half1_N6'=  half1.N6 %>% select(-contains('model')) %>% apply(., 2, which.min), 
                     'half2_N3'= half2.N3 %>% select(-contains('model')) %>% apply(., 2, which.min), 
                     'half2_N6'= half2.N6 %>% select(-contains('model')) %>% apply(., 2, which.min)
                     )
